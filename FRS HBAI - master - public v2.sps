...
insert file = "FRS HBAI - change - public v2.sps".
...
insert file = "FRS HBAI - tables - public v2.sps".

* Figure 1a - Line chart - tenure by year - adults and children separately.
insert file = "FRS HBAI - Fig 1a - public v2.sps".

* Figures 5, 6 and 10 - heatmaps for adults.
insert file = "FRS HBAI - Fig 5 - public v2.sps".
insert file = "FRS HBAI - Fig 6 - public v2.sps".
insert file = "FRS HBAI - Fig 10 - public v2.sps".
...
insert file = "FRS HBAI - tables ch - public v2.sps".

* Figure 1b - Line chart - tenure by year - adults and children separately.
insert file = "FRS HBAI - Fig 1b - public v2.sps".

* Figures 8a/b/c and 9 - line charts for children.
insert file = "FRS HBAI - Fig 8a - public v2.sps".
insert file = "FRS HBAI - Fig 8b - public v2.sps".
insert file = "FRS HBAI - Fig 8c - public v2.sps".
insert file = "FRS HBAI - Fig 9 - public v2.sps".
