...
dataset close all.
output close all.
*** FRS HBAI - Fig 8a - public v2.sps.
***   v1 - Dec 2018.
***   v2 - Jul 2019: updated for 2017/18 data.

***   Syntax creates Figure 8a for Bailey, Nick (2018) Poverty and the re-growth of private renting in the UK. 
...
*** Figure 8a. Line graph - 4 tenures by year - UK - pov AHC. 
...
BEGIN GPL
  ...
  GUIDE: axis(dim(2), label("Share of low income poverty"))
...
OUTPUT EXPORT
  ...
  /TIF  IMAGEROOT='Fig8a.tiff'
     PERCENTSIZE=100.

OUTPUT SAVE NAME=*
 OUTFILE='Figure 8a.spv'
 LOCK=NO.
...
* csv - reordering vars.
SAVE TRANSLATE OUTFILE='FRS HBAI - fig 8a.csv'
  /TYPE=CSV
  /ENCODING='UTF8'
